...
def calcular_precio_final():
    ...
    if tiene_cupon == "si":
        ...
        if valor_cupon > 0:
            ...
            print(f"Se aplico un descuento de {valor_cupon} euros. El precio final es {precio_final} euros.")
        else:
            print("El valor del cupón no es válido, debe ser mayor a cero.")
            print(f"El precio final es {precio_original}")
    else:
        print(f"No tienes cupón. El precio final es {precio_original}")